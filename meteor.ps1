...
$script:FeatureToFlagMapping = @{
    ...
    "NTPEnterpriseShortcuts"                                = "enable-ntp-enterprise-shortcuts"
    ...
    "MlUrlScoring"                                          = "omnibox-ml-url-scoring"
    ...
    "MlUrlScoreCaching"                                     = "omnibox-ml-url-score-caching"
    "UrlScoringModel"                                       = "omnibox-ml-url-scoring-model"
    ...
    "OmniboxOnDeviceHeadProviderNonIncognito"               = "omnibox-on-device-head-suggestions"
    "OmniboxOnDeviceTailModel"                              = "omnibox-on-device-tail-suggestions"
    ...
    # AI API Features
    "AIPromptAPI"                                           = "prompt-api-for-gemini-nano"
    "AIPromptAPIMultimodalInput"                            = "prompt-api-for-gemini-nano-multimodal-input"
    "AISummarizationAPI"                                    = "summarization-api-for-gemini-nano"
    "AIWriterAPI"                                           = "writer-api-for-gemini-nano"
    "AIRewriterAPI"                                         = "rewriter-api-for-gemini-nano"
    "AIProofreadingAPI"                                     = "proofreader-api-for-gemini-nano"
